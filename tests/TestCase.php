...
namespace ConsulConfigManager\Consul\ACL\Test;
...
use ConsulConfigManager\Consul\ACL\Providers\ConsulACLServiceProvider;

/**
 * Class TestCase
 * @package ConsulConfigManager\Consul\ACL\Test
 */
abstract class TestCase extends \ConsulConfigManager\Testing\TestCase
{
    ...
    protected array $packageProviders = [
        ...
        ConsulACLServiceProvider::class,
    ...
    public function setUpEnvironment(Application $app): void
    {
        ...
        $this->setconfigurationValue('consul.acl', [
