 ...
 */
class RoleUpdatedTest extends AbstractRoleEventTest
{
    /**
     * @inheritDoc
     */
    protected string $activeEventHandler = RoleUpdated::class;
    ...
    {
        $this->assertInstanceOf(RoleUpdated::class, $this->createClassInstance($data));
    }
     ...
     * @inheritDoc
     */
    protected function createClassInstance(array $data): RoleUpdated
    {
