 ...
 */
class TokenUpdated extends AbstractEvent
{
    /**
     * Token secret id
     * @var string
     ...
     * @return void
     */
    public function __construct(string $secret, string $description, array $roles, array $policies, bool $local, UserInterface|int|null $user = null)
    {
        $this->secret = $secret;
